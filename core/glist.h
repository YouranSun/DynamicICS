...
class GLIST final: public CoreMaintenance {
 public:
  ...
  void Insert(const int v1, const int v2,
              ...
              std::vector<int>& core);
  void InsertRem(const int v1, const int v2,
              std::vector<std::vector<int>>& graph,
              std::vector<int>& core,
              std::vector<std::vector<int> >&core_inc);
  void InsertUpd(const int v1, const int v2,
              std::vector<std::vector<int>>& graph,
              std::vector<int>& core,
              int &k_max);
